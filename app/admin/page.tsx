...
export default async function AdminPage() {
  ...
  return (
    <main className="min-h-screen font-mono t-text bg-black text-white p-4 sm:p-8">
      <div className="max-w-3xl mx-auto space-y-8">
        <div className="flex justify-between items-center flex-wrap gap-2">
          <h1 className="text-2xl font-black uppercase tracking-tighter">Admin · Produkte</h1>
        ...
        <section className="space-y-4">
          ...
          {allProducts.length === 0 && (
            <p className="text-xs text-zinc-600 uppercase tracking-widest">Noch keine Produkte angelegt.</p>
          )}
          {allProducts.map((p) => (
            <ProductRow
              key={p.id}
