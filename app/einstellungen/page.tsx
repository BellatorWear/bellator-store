...
export default async function EinstellungenPage() {
  ...
  const usernameCooldownDays = daysUntilUsernameChangeAllowed(
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <section className="t-card border p-4">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-xs font-bold uppercase tracking-widest t-muted">
                    Erscheinungsbild
                  </h2>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs t-faint mt-1">
                    Direkt im Browser benachrichtigt werden
                  </p>
                </div>
                <NotificationToggle
                  initialEnabled={user.pushEnabled ?? false}
                />
              </div>
            </section>
            ...
            <section className="t-card border p-4">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs t-faint mt-1">
                    Drops & Aktionen per Email
                  </p>
                </div>
                <NewsletterToggle
                  initialEnabled={user.newsletterOptIn ?? false}
                />
              </div>
            </section>
            ...
            <section className="t-card border p-4 space-y-2 text-xs">
              <h2 className="font-bold uppercase tracking-widest t-muted">
                Konto
              </h2>
