...
export default async function GlobalHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 bg-black/90 backdrop-blur-md border-b border-zinc-800 px-4 sm:px-6 py-3 flex items-center justify-between font-mono t-no-invert">
